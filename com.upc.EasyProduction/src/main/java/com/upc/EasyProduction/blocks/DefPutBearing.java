...
public class DefPutBearing extends Block {
			
	// Singleton (only one instance)
	
	private static DefPutBearing singleton = new DefPutBearing();
	
	
	private DefPutBearing() {
	...
	public static DefPutBearing getInstance() {
		return singleton;
	}
