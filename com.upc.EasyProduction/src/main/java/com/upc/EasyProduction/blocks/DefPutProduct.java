...
public class DefPutProduct extends Block {
		
	// Singleton (only one instance)
	
	private static DefPutProduct singleton = new DefPutProduct();
	
	
	private DefPutProduct() {
	...
	public static DefPutProduct getInstance() {
		return singleton;
	}
